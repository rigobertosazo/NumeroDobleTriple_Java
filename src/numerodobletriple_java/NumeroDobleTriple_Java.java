package numerodobletriple_java;
import java.util.Scanner;

/**
 * @author Rib
 */
public class NumeroDobleTriple_Java {
    /*Programa que lee un numeros entero por teclado y muestra el doble y triple del numero ingresado en pantalla*/
